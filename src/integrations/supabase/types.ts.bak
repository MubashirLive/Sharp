    ...
    Tables: {
      ...
      staff_profile_extended: {
        Row: {
          ...
          increment_due_date: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "staff_profile_extended_profile_id_fkey"
            columns: ["profile_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "staff_profile_extended_school_id_fkey"
            columns: ["school_id"]
            isOneToOne: false
            referencedRelation: "schools"
            referencedColumns: ["id"]
